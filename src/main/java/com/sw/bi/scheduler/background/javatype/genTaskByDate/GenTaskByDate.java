...
public class GenTaskByDate {
	...
	public static void main(String args[]) throws SchedulerException {
		...
		GenTaskByDate.GenTaskByDate().genTaskByDate(date);

	}

	private static GenTaskByDate GenTaskByDate() {
		return BeanFactory.getBean(GenTaskByDate.class);
	}
