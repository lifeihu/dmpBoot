...
//   /home/tools/scheduler/scheduler_test jar   /home/tools/scheduler/scheduler_test.jar com.sw.bi.scheduler.background.javatype.precompute.PreComputeWeek
@Component
public class PreComputeWeek {
	...
	public static void main(String args[]){
		...
		PreComputeWeek.PreComputeWeek().computeWeek();
		
	}
	
	
	private static PreComputeWeek PreComputeWeek() {
		return BeanFactory.getBean(PreComputeWeek.class);
	}
	...
	public void computeWeek(){
		...
		List<Job> jobs = jobService.getOnlineJobsByCycleType(Configure.JobCycle.WEEK.indexOf());
		for(Job job:jobs){
