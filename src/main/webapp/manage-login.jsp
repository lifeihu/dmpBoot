...
<head>
	...
	<script type="text/javascript">
		_import('com.sw.bi.scheduler.application.LoginForm');
	</script>

	<style>
		.yzm,#ext-gen36 {float:left;}
		.yzm {padding-left: 10px;margin-top: -2px;}
		.yzm .x-btn-tl,.yzm .x-btn-tr,.yzm .x-btn-tc,.yzm .x-btn-ml,.yzm .x-btn-mr,.yzm .x-btn-mc,.yzm .x-btn-bl,.yzm .x-btn-br,.yzm .x-btn-bc{
			background: none;}
		#ext-gen38 {border: 1px solid #12a9cc;color:#12a9cc;
		...
		#ext-gen20 {width:112px;
			height: 36px;
			border: 1px solid #bd0a0a;color:#fff;
