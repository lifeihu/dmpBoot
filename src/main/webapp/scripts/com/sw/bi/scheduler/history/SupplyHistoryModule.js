...
com.sw.bi.scheduler.history.SupplyHistoryModule = Ext.extend(framework.modules.SearchGridModule, {
	...
	searcher: function() {
		return {
			items: [{
				...
				xtype: 'hidden', name: 'flag-ge', value: 2
			}, {
				columnWidth: .15,
				xtype: 'combo',
				fieldLabel: '最近七天',
	...
	detailer: function() {
		return {
			...
			columns: [{
				...
				xtype: 'customcolumn',
				header: '开始日期',
				dataIndex: 'minTaskDate',
				dateColumn: true
			}, {
				xtype: 'customcolumn',
				header: '结束日期',
				dataIndex: 'maxTaskDate',
				dateColumn: true
			}, {
				xtype: 'customcolumn',
				header: '操作日期',
			...
			store: {
				...
				fields: ['taskDate', 'cycleType', 'settingTime', 'userGroupId']
			}
		};
	},
	...
	viewDetail: function(record) {
		this.createWindow({
			...
			module: {
				module: 'com.sw.bi.scheduler.history.SupplyHistoryListModule',
